 ...
 */
function apnc_preprocess_html(&$variables, $hook) {
    $node = menu_get_object('node');
    if (drupal_is_front_page()) {
        $variables['classes_array'][] = 'home';
    }
    if (in_array('sidebar_content_right', $variables['page'])) {
        unset($variables['classes_array']['no-sidebars']);
        $variables['classes_array'][] = 'sidebar_content_right';
    }
    if (isset($node) && (!empty($node->field_page_rightsidebar))) {
        unset($variables['classes_array']['no-sidebars']);
        $variables['classes_array'][] = 'sidebar_content_right';
    }
}
...
function apnc_preprocess_node(&$vars) {
...
function apnc_menu_link__main_menu(&$variables) {
